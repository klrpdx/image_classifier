...
def get_args():
    ...
    parser.add_argument("-r", "--learning_rate", dest="learning_rate", help="learning rate for training", type=float, default=.01),
    parser.add_argument("-u", "--hidden_units", dest="hidden_units", type=int, help="Number of hidden units", default=512)
